package com.beelabs.tbcinfo.ui.component.calendar.view;
...
import com.beelabs.tbcinfo.ui.component.calendar.adapters.CalendarPageAdapter;
...
//        FontUtil.fontFace(new int[]{R.id.mondayLabel, R.id.tuesdayLabel, R.id.wednesdayLabel, R.id.thursdayLabel, R.id.fridayLabel, R.id.saturdayLabel, R.id.sundayLabel}, FontUtil.GELPEN_LIGHT, view);
//        FontUtil.fontFace(R.id.currentDateLabel, FontUtil.TITILLIUM_WEB_BOLD, view);
        initUiElements();
        setAttributes(attrs);
        initCalendar();
    }
